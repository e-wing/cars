...
SampleColor.create!(value_one: "Green", value_two:"Spray Paint", car_model_id: 1)
SampleColor.create!(value_one: "Black", value_two:"Nail Polish", car_model_id: 2)
...
SampleColor.create!(value_one: "Orange", value_two:"Watercolor", car_model_id: 2)
SampleColor.create!(value_one: "Sea Green", value_two:"Metallic", car_model_id: 3)


SampleFinish.create!(value_one: "Eggshell",  sample_color_id: 3)
...
SampleFinish.create!(value_one: "Sparkly",  sample_color_id: 2)
